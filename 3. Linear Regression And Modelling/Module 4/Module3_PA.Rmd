...
audience_rating ("Upright" value adds 20.05 - "Spilled" adds nothing: p.value = 0),
best_pic_nom (yes adds 3.52: p.value = 0.0271)

* Less Significant Predictors (added for extrapolation)

runtime, critics_score and best_actress_win (yes subtracts -1.3)
