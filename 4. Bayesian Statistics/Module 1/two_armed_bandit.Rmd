...
shinyApp(ui = fluidPage(tags$head(tags$style(type = "text/css", 
        ...
        column(width = 4, fluidRow(column(width = 5, h4("Machine 1:"), 
            actionButton("m1_play", "Play!", class = "btn btn-primary", 
                ...
                icon = icon("stack-overflow", class = "fa-2x"))), 
            column(width = 1), column(width = 5, h4("Machine 2:"), 
                actionButton("m2_play", "Play!", 
                  class = "btn btn-success", width = "100px", 
                  style = "white-space: normal;", icon = icon("stack-overflow", 
                    class = "fa-2x")))), br(), h4("Results:"), 
...
**Exercise 1**: Use the Shiny App above to play the slot machines a total of *10* times. You can 
...
<div class="task exercise">
**Exercise 2**: Press the Reset button again, now play *30* times and use those results to guess 
...
<div class="question">
**Question 1**: Based on the preceding result, what is the probability that Machine 1 is "Bad" 
...
<div class="question">
**Question 2**: Based on the preceding result, what is the probability that Machine 2 is "Good" 
given you won a game playing on Machine 1?
...
<div class="question">
**Question 4**: Use the `bandit_posterior` function to calculate the posterior probabilities of 
...
<div class="question">
**Question 5**: What would the posterior probabilities be if we had instead played Machine 2 
...
<div class="exercise">
**Exercise 3**: Confirm the updating property we discussed previously by connecting two calls of 
...
data1 <- data.frame(machine = c(1L, 1L, 2L, 2L, 2L), outcome = c("W", "L", "L", "W", "W"))
bandit_posterior(data1)
```

<div class="exercise">
**Exercise 5**: Reset the simulation and then play at least *50* times. Suppose you pause after 
...
```{r E5}
# Type your code for Exercise 5 here 5 of 10 sims each 5 times for each bandit
data1 <- data.frame(machine = c(1L, 2L, 2L, 1L, 1L, 1L, 2L, 2L, 2L, 1L), 
                    outcome = c("L", "L", "W", "L", "W", "L", "L", "L", "L", "L"))
data2 <- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), 
                    outcome = c("L", "L", "L", "L", "W", "L", "W", "L", "W", "W"))
data3 <- data.frame(machine = c(1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 1L, 2L), 
                    outcome = c("W", "W", "L", "L", "W", "L", "W", "W", "L", "W"))
data4 <- data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L), 
                    outcome = c("W", "W", "L", "L", "L", "L", "L", "L", "L", "W"))
data5 <- data.frame(machine = c(1L, 1L, 1L, 2L, 2L, 2L, 1L, 1L, 2L, 2L), 
                    outcome = c("L", "W", "W", "L", "L", "L", "W", "W", "W", "L"))
bandit_posterior(data1) %>% bandit_posterior(data2,prior = .) %>% 
  bandit_posterior(data3,prior = .) %>% bandit_posterior(data4,prior = .) %>% 
...
plot_bandit_posterior_update <-
        function (data,
                ...
                ggplot(r, aes(
                        ...
                        y = prob,
                        color = outcome,
                        group = outcome)) + geom_line(linewidth = 1.5) + 
...
<div class="exercise">
**Exercise 6**: Plot the result of your last 50 plays using the code `plot_bandit_posterior(data)` as shown in the example above, 
...
<div class="question">
**Question 6**: From the plot generated in the example above, we can see that the posterior probabilities for Machine 1 
and Machine 2 mirror each other. Why will this happen?

* $P(M_1 \text{ is good}|~\text{data})$ and $P(M_2\text{ is bad}|~\text{data})$ are complementary
